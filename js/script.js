...
tlClose.add("close")
  .to(menuTop, 0.2, {
  backgroundColor: "#2c4107", ease: Power4.easeInOut, onComplete: function() {
    logo.css('z-index','26');
...
.to(menuMiddle, 0.2, {
  backgroundColor: "#2c4107", ease: Power4.easeInOut
}, "close") 
.to(menuBottom, 0.2, {
  backgroundColor: "#2c4107", ease: Power4.easeInOut
}, "close")
...
.to(menuBottom, 0.8, {
  ...
  ease: Power4.easeInOut,
  onComplete: function() {
    menuTop.css('background-color','#FFC107');
    menuMiddle.css('background-color','#FFC107');
    menuBottom.css('background-color','#FFC107');
  }
}, "close", "+=0.2")
